...
describe("calculate_to_hit", () => {
  it("should return 50% for a flat DC10", () => {
    const result = calculateToHit(0, 0, 0, 10, false, false);
    const correct = 0.50;
    expect(result).toBe(correct);
  });

  it("should return 60% for +5 on AC13", () => {
    const result = calculateToHit(5, 0, 0, 13, false, false);
    const correct = 0.60;
    expect(result).toBe(correct);
  });

  it("should correctly apply bonus parameters", () => {
    const attack = calculateToHit(0, 2, 0, 10, false, false);
    const turn   = calculateToHit(0, 0, 2, 10, false, false);
    const correct = 0.60;
